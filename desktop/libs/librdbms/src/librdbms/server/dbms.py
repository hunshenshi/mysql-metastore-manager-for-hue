...
class Rdbms(object):
  ...
  def get_comment(self, database, table=None):
    return self.client.get_comment(database, table)

  def alter_table_comment(self, database, table_name, comment):
    return self.client.alter_table_comment(database, table_name, comment)

  def alter_column_comment(self, database, table_name, column_name, column_type, comment):
    return self.client.alter_column_comment(database, table_name, column_name, column_type, comment)
