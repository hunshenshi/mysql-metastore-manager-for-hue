...
setup(
  ...
  version = "0.1",
  url = 'TODO',
  description = 'mysql metastore manager',
  author = 'sunzhiwei',
  packages = find_packages('src'),
  package_dir = {'': 'src'},
  install_requires = ['setuptools', 'desktop'],
  entry_points = { 'desktop.sdk.application': 'rdbMetaStore=rdbMetaStore' },
  zip_safe = False,
  package_data = {
    # Include static resources.  Package_data doesn't
    # deal well with directory globs, so we enumerate
    # the files manually.
    'rdbMetaStore': expand_package_data(
      ["src/rdbMetaStore/templates", "src/rdbMetaStore/static"],
      "src/rdbMetaStore/")
  }
)
