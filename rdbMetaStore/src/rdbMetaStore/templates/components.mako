        ...
        <div class="container-fluid">
          <div class="nav-collapse">
            <ul class="nav">
              <li class="currentApp">
                <a href="/${app_name}">
                  <img src="${ static('rdbMetaStore/art/icon_rdbMetaStore_48.png') }" class="app-icon" />
                  ${ _('Mysql Metastore Manager') }
                </a>
              </li>              
            </ul>
...
<%def name="breadcrumbs(breadcrumbs, icon='')">
  <ul class="nav nav-pills hueBreadcrumbBar" id="breadcrumbs">
    ...
    %endif
    <li>
      <a href="${url('rdbMetaStore:databases')}">${_('Databases')}</a><span class="divider">&gt;</span>
    </li>
